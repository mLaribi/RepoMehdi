<%@ Page Title="Vagabones | S'inscrire" MasterPageFile="~/GabGeneral.Master" Language="C#" AutoEventWireup="true" CodeBehind="Inscription.aspx.cs" Inherits="TP3_Youyous_MLaribi.Inscription" %>




<asp:Content ID="ContenuInscription" ContentPlaceHolderID="ContentPlaceHolderContenu" runat="server">
    <div id="frmInscription">

        <%-- Formulaire d'inscription--%>
        <a class="titre">Formulaire d'inscription : </a>
    <br />
    <br />
        <%--Nom de l'usager --%>
    <div>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidatorNom" runat="server" 
            ControlToValidate="txtNom" CssClass="msg_erreur" ValidationGroup="valideInsc"
    ...
    <div>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidatorPrenom" runat="server" 
            ControlToValidate="txtPrenom" CssClass="msg_erreur" ValidationGroup="valideInsc"
        ...
        <asp:RequiredFieldValidator ID="requiredAdresse" runat="server" 
            ControlToValidate="txtAdresse" CssClass="msg_erreur" ValidationGroup="valideInsc"
    ...
    &nbsp;</div>
         <asp:RequiredFieldValidator ID="RequiredCodePostal" runat="server" ValidationGroup="valideInsc" ControlToValidate="txtCodeP"
        ...
        <asp:RequiredFieldValidator ID="RequiredVille" runat="server" 
            ControlToValidate="txtVille" CssClass="msg_erreur" ValidationGroup="valideInsc"
        ...
        <asp:RequiredFieldValidator ID="RequiredTelephone" runat="server" 
            ControlToValidate="txtTelephone" CssClass="msg_erreur" ValidationGroup="valideInsc"
        ...
        <%--Pseudo de l'usager--%>
    <div>
        <asp:Label ID="lblPseudo" runat="server" Text="Pseudo : " 
            AssociatedControlID="txtPseudo"></asp:Label>
        <asp:TextBox ID="txtPseudo" runat="server" MaxLength="12"></asp:TextBox>
        <asp:RequiredFieldValidator ID="ValidePseudo" runat="server" 
            ControlToValidate="txtPseudo" CssClass="msg_erreur" ValidationGroup="valideInsc"
        ...
        <asp:CompareValidator ID="CompareValidatorMotPasse" runat="server" 
           ...
           CssClass="msg_erreur" Display="Dynamic" 
            ErrorMessage="Les mots de passe entrés doivent être pareils" ValidationGroup="valideInsc">*</asp:CompareValidator>
        <asp:RequiredFieldValidator ID="RequiredFieldValidatorMotPasse" runat="server" 
            ...
            Display="Dynamic" ErrorMessage="Le mot de passe est obligatoire" ValidationGroup="valideInsc">*</asp:RequiredFieldValidator>
        <br />
    ...
    <div id="affErreur">
    <asp:ValidationSummary ID="ValideInscription" runat="server" 
            CssClass="msg_erreur" ValidationGroup="valideInsc" HeaderText="Veuillez corriger les erreurs suivantes: " />
    </div>

    <div>
        <br /><br />
        <asp:Button ID="ButtonEnvoyer" runat="server" ValidationGroup="valideInsc" onclick="ButtonEnvoyer_Click" 
            Text="Envoyer" />
